...
class LargeMultipleHTMLFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFormatHTMLMultipleDateLargeOneDay()
    {
        ...
        $expectedOutput .= '</time>';
        $expectedOutput .= '<time itemprop="startDate" datetime="2017-11-16T20:00:00+01:00">';
        $expectedOutput .= '<span class="cf-weekday cf-meta">donderdag</span>';
        $expectedOutput .= ' ';
        ...
        $expectedOutput .= '<span class="cf-time">22:00</span>';
        $expectedOutput .= '</time>';
        $expectedOutput .= '<time itemprop="startDate" datetime="2017-11-23T20:00:00+01:00">';
        $expectedOutput .= '<span class="cf-weekday cf-meta">donderdag</span>';
        $expectedOutput .= ' ';
        ...
        $expectedOutput .= '<span class="cf-time">22:00</span>';
        $expectedOutput .= '</time>';
        $expectedOutput .= '<time itemprop="startDate" datetime="2017-11-30T20:00:00+01:00">';
        $expectedOutput .= '<span class="cf-weekday cf-meta">donderdag</span>';
        $expectedOutput .= ' ';
    ...
    public function testFormatHTMLMultipleDateLargeMoreDays()
    {
        ...
        $expectedOutput .= '<time itemprop="startDate" datetime="2017-11-14T20:00:00+01:00">';
        $expectedOutput .= '<span class="cf-from cf-meta">Van</span>';
        $expectedOutput .= ' ';
        ...
        $expectedOutput .= '<time itemprop="startDate" datetime="2017-11-21T20:00:00+01:00">';
        $expectedOutput .= '<span class="cf-from cf-meta">Van</span>';
        $expectedOutput .= ' ';
        $expectedOutput .= '<span class="cf-weekday cf-meta">dinsdag</span>';
        $expectedOutput .= ' ';
        ...
        $expectedOutput .= '<time itemprop="startDate" datetime="2017-11-28T20:00:00+01:00">';
        $expectedOutput .= '<span class="cf-from cf-meta">Van</span>';
        $expectedOutput .= ' ';
        $expectedOutput .= '<span class="cf-weekday cf-meta">dinsdag</span>';
        $expectedOutput .= ' ';
