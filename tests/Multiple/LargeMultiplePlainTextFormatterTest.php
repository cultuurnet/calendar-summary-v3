...
class LargeMultiplePlainTextFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFormatPlainTextMultipleDateLargeOneDay()
    {
        ...
        $expectedOutput .= ' van 20:00 tot en met 22:00' . PHP_EOL;
        ...
        $expectedOutput .= ' van 20:00 tot en met 22:00';
    ...
    public function testFormatPlainTextMultipleDateLargeMoreDays()
    {
        ...
        $expectedOutput = 'Van maandag 6 november 2017 20:00 tot en met donderdag 9 november 2017 22:00' . PHP_EOL;
        $expectedOutput .= 'Van dinsdag 14 november 2017 20:00 tot en met donderdag 16 november 2017 22:00' . PHP_EOL;
        $expectedOutput .= 'Van dinsdag 21 november 2017 20:00 tot en met donderdag 23 november 2017 22:00' . PHP_EOL;
        $expectedOutput .= 'Van dinsdag 28 november 2017 20:00 tot en met donderdag 30 november 2017 22:00';
